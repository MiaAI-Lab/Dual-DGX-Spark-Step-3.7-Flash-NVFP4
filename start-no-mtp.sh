...
make_node_script "$REPO_ROOT/templates/launch-no-mtp.sh" "$HEAD_SCRIPT" "$TP_SIZE" 0 "$HEAD_IP"
make_node_script "$REPO_ROOT/templates/launch-no-mtp.sh" "$WORKER_SCRIPT" "$TP_SIZE" 1 "$HEAD_IP"
